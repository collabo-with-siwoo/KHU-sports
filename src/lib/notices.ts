...
const seededNotices: NoticeView[] = [
  {
    ...
    category: "대회 안내",
    summary:
      "제27회 경희대학교 총장배 전국 골프대회 참가 신청은 이메일 접수 후 운영진 확인을 거쳐 확정됩니다.",
    content:
      "제27회 경희대학교 총장배 전국 골프대회 참가 신청은 khusports2026@gmail.com 이메일 접수로 진행됩니다. 참가자는 신청서와 필수 확인 자료를 제출해야 하며, 운영진 검토 후 참가 확정 안내를 받습니다. 일반 회원으로 가입한 사용자는 관리자 승인 후 선수 권한으로 전환됩니다.",
